                    ...
                    <div className="tf-slider-item style-4">
                      <div className="content-inner">
                        ...
                        <div className="btn-slider ">
                          <Link to="/explore-v1" className="tf-button style-2">Explore <i
                            className="fas fa-long-arrow-right"></i></Link>
                        </div>
                      </div>
                      <div className="image">
                        ...
                        <div className="card-countdown">
                          ...
                          <span className="js-countdown countdown style-3" data-timer="55555"
                                data-labels=" ,  h , min , s "></span>
                        </div>
                      </div>
                    </div>
                  </SwiperSlide>
