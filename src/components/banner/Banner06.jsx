                  ...
                  <SwiperSlide key={idx.id}>
                    <div className="tf-slider-item style-6">
                      <div className="content-inner">
                        ...
                        <p className="sub-heading">Lorem Ipsum Dolor Sit Amet, Consectetur Adipiscing Elit. Integer Nec
                          Odio. Praesent Libero. Sed </p>
                        ...
                        <div className="sc-product style1 ">
                          ...
                          <div className="bottom">
                            <div className="product-button">
                              <Link to="#" data-toggle="modal" data-target="#popup_bid" className="tf-button"> <span
                                className="icon-btn-product"></span> Place Bid</Link>
                            </div>
                          ...
                          <div className="bottom">
                            <div className="details-product">
                              ...
                              <div className="bid">
                                ...
                                <div className="price">
                                  <span className="cash">5 ETH</span><span className="icon"><img src={icon3}
                                                                                                 alt="images"/></span>
                                </div>
                              </div>
                            </div>
