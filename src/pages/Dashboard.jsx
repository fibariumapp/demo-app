...
import {getCurrentWalletConnected, getPermissions} from "../api/interact";
import {binanceLogoSVG, discordSVG, emailLogoSVG, galxeLogoSVG, twitterLogoSVG} from "../components/svg_logo";
...
function shorter(str, n) {
    if (str.length < n || str.length < n * 2) {
        return str
    }
...
async function getTokenBalance(walletAddress) {
    const RPC_BSC_TESTNET = 'https://bsc-testnet.nodereal.io/v1/e9a36765eb8a40b9bd12e680a1fd2bc5';
    const RPC_OPBNB_TESTNET = 'https://opbnb-testnet-rpc.bnbchain.org'
    const provider = new ethers.JsonRpcProvider(RPC_OPBNB_TESTNET);
    const balanceWei = await provider.getBalance(walletAddress);
    return ethers.formatEther(balanceWei);
}


const permissionItemCategory = (property) => {
    switch (property.o) {
        case 1:
            return "Web";
        case 2:
...
const permissionItemLogo = (property) => {
    switch (property.t) {
        case "galxe passport":
            return galxeLogoSVG
        case "twitter":
...
const permissionItemName = (property) => {
    switch (property.t) {
        case "galxe passport":
            return "Galxe Passport";
        case "twitter":
            return "Twitter";
        case "bab":
            return "BAB Token";
...
const permissionItemAccount = (property) => {
    switch (property.t) {
        case "galxe passport":
            return shorter(property.c, 8);
        case "twitter":
            return shorter(property.v, 8);
        case "bab":
            return shorter(property.c, 8);
        case "email":
            return shorter(property.v, 8);
...
const permissionItemLink = (property) => {
    switch (property.t) {
        case "galxe passport":
            const url1 = "https://bscscan.com/token/0x" + property.c + "?a=" + property.i;
            return <a target="_blank" rel="noreferrer" href={url1}>Show token</a>;
        case "twitter":
            const url2 = "https://twitter.com/" + property.v;
            return <a target="_blank" rel="noreferrer" href={url2}>Show account</a>;
        case "bab":
            const url3 = "https://bscscan.com/token/0x" + property.c + "?a=" + property.i;
            return <a target="_blank" rel="noreferrer" href={url3}>Show token</a>;
        case "email":
            const url4 = "https://" + property.v.split('@')[1];
            return <a target="_blank" rel="noreferrer" href={url4}>Show account</a>;
        case "discord":
            const url5 = "https://discord.com/users/" + property.v;
            return <a target="_blank" rel="noreferrer" href={url5}>Show account</a>;
        default:
            return <a/>;
    }
};
...
const permissionItemStatus = (property) => {
    // return <><i className="fas fa-circle" style={{color: '#a11212'}}></i>Failed</>
    return <><i className="fas fa-circle" style={{color: '#0b8d0b'}}></i>Success</>
}
    ...
    return (
        <div className="content-ranking">
            <div className="col-rankingg">
                {permissionItemCategory(property)}
            </div>
            <div className="col-rankingg">
                {permissionItemLogo(property)}
                {permissionItemName(property)}
            </div>
            <div className="col-rankingg coin">
                {permissionItemAccount(property)}
            </div>
            <div className="col-rankingg">fibarium.com</div>
            <div className="col-rankingg">
                {permissionItemLink(property)}
            </div>
            <div className="col-rankingg nofication">
                {permissionItemStatus(property)}
            </div>
...
function Dashboard(props) {
    ...
    const [walletPermissions, setWalletPermissions] = useState([]);

    const requestPermissions = async (address) => {
        const {status, message, permissions} = await getPermissions(address);
    ...
    useEffect(() => {
        ...
        async function getExistingWallet() {
            ...
            // await requestPermissions(address);
        }
    ...
    console.log('walletPermissions', walletPermissions)
                            ...
                            <div className="col-xl-3 col-lg-12 col-md-12">
                                <div className="dashboard-user">
                                    <div className="dashboard-infor">
                                        ...
                                        <div className="pax"><i
                                            className="fab fa-ethereum"></i>{shorter(walletAddress, 8)}</div>
                                        ...
                                        <Tab><a>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                ...
                                                <path className="svg-fill"
                                                      ...
                                                      fill="#3749E9"/>
                                                <path className="svg-fill"
                                                      d="M17.3257 12.2503C16.3923 12.8753 15.084 13.1087 13.8757 12.9503C14.1923 12.267 14.359 11.5087 14.3673 10.7087C14.3673 9.87534 14.184 9.08367 13.834 8.392C15.0673 8.22534 16.3757 8.45867 17.3173 9.08367C18.634 9.95034 18.634 11.3753 17.3257 12.2503Z"
                                                      fill="#3749E9"/>
                                                <path className="svg-fill"
                                                ...
                                                <path className="svg-fill"
                                                      ...
                                                      fill="#3749E9"/>
                                                <path className="svg-fill"
                                                      d="M7.39102 14.9492C6.13268 15.7909 6.13268 17.1742 7.39102 18.0076C8.82435 18.9659 11.1743 18.9659 12.6077 18.0076C13.866 17.1659 13.866 15.7826 12.6077 14.9492C11.1827 13.9909 8.83268 13.9909 7.39102 14.9492Z"
                                                      fill="#3749E9"/>
                                            </svg>
                                            Following </a></Tab>
                                        <Tab><a>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                 viewBox="0 0 20 20" fill="none">
                                                <path className="svg-fill"
                                                      d="M13.1493 1.66797H6.84935C3.69935 1.66797 2.91602 2.50964 2.91602 5.86797V15.2513C2.91602 17.468 4.13268 17.993 5.60768 16.4096L5.61602 16.4013C6.29935 15.6763 7.34102 15.7346 7.93268 16.5263L8.77435 17.6513C9.44935 18.543 10.541 18.543 11.216 17.6513L12.0577 16.5263C12.6577 15.7263 13.6993 15.668 14.3827 16.4013C15.866 17.9846 17.0743 17.4596 17.0743 15.243V5.86797C17.0827 2.50964 16.2993 1.66797 13.1493 1.66797ZM12.291 8.95964H7.70768C7.36602 8.95964 7.08268 8.6763 7.08268 8.33464C7.08268 7.99297 7.36602 7.70964 7.70768 7.70964H12.291C12.6327 7.70964 12.916 7.99297 12.916 8.33464C12.916 8.6763 12.6327 8.95964 12.291 8.95964Z"
                                                      fill="#3749E9"/>
                                            </svg>
                                            Favorites</a></Tab>
                                        {/*<Tab><a>*/}
                                ...
                                <div className="dashboard-content inventory content-tab">
                                    <TabPanel>
                                        <div className="inner-content profile">
                                            <h4 className="title-dashboard">Permissions</h4>
                                            <div className="table-ranking top">
                                                <div className="title-ranking">
                                                    <div className="col-rankingg"><Link to="#">Category</Link></div>
                                                    <div className="col-rankingg"><Link to="#">Name</Link></div>
                                                    <div className="col-rankingg"><Link to="#">Account</Link></div>
                                                    <div className="col-rankingg"><Link to="#">Issued</Link></div>
                                                    <div className="col-rankingg"><Link to="#">Link</Link></div>
                                                    <div className="col-rankingg"><Link to="#">Verified</Link></div>
                                                </div>
                                            </div>
                                            <div className="table-ranking ">

                                                {walletPermissions.map((property) => (
                                                    <PermissionItem property={property} key={property.t}/>
                                                ))}

                                                <div className="table-btn">
                                                    <Link to="#" onClick={() => requestPermissions(walletAddress)}>
                                    ...
                                    <TabPanel>
                                        <div className="inner-content inventory">
                                            ...
                                            <div className="table-ranking ">
                                                <div className="content-ranking">
                                                    <div className="col-rankingg">
                                                        <div className="image"><img src={img1} alt="Binasea"/></div>
                                                    </div>
                                                    ...
                                                    <div className="col-rankingg nofication"><i
                                                        className="fas fa-circle"></i> Running
                                                    </div>
                                                    <div className="col-rankingg dot"><Link to="#"><i
                                                        className="fas fa-ellipsis-h"></i></Link>
                                                    </div>
                                                </div>
                                                <div className="content-ranking">
                                                    <div className="col-rankingg">
                                                        <div className="image"><img src={img2} alt="Binasea"/></div>
                                                    </div>
                                                ...
                                                <div className="content-ranking">
                                                    <div className="col-rankingg">
                                                        <div className="image"><img src={img3} alt="Binasea"/></div>
                                                    </div>
                                                    <div className="col-rankingg">Art</div>
                                                    <div className="col-rankingg coin">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="22"
                                                ...
                                                <div className="content-ranking">
                                                    <div className="col-rankingg">
                                                        <div className="image"><img src={img4} alt="Binasea"/></div>
                                                    </div>
                                                    <div className="col-rankingg">Art</div>
                                                    <div className="col-rankingg coin">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="22"
                                                ...
                                                <div className="content-ranking">
                                                    <div className="col-rankingg">
                                                        <div className="image"><img src={img5} alt="Binasea"/></div>
                                                    </div>
                                                    ...
                                                    <div className="col-rankingg coin">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="22"
                                                             ...
                                                             fill="none">
                                                            <path fillRule="evenodd" clipRule="evenodd"
                                                                  d="M15.0938 4.46826V0.515625C19.6588 1.96675 22.7579 6.20623 22.7621 10.9983C22.7538 15.7862 19.6546 20.0172 15.0938 21.4684V17.5326C17.5522 16.2797 19.0976 13.7572 19.0976 10.9983C19.0934 8.2395 17.548 5.72112 15.0938 4.46826ZM0.761719 10.9974C0.765907 6.20952 3.86928 1.97425 8.4301 0.527344V4.45888C5.97169 5.70753 4.42629 8.23434 4.42629 10.9932C4.43048 13.752 5.97588 16.2704 8.4301 17.5232V21.4759C3.86509 20.0247 0.761719 15.7895 0.761719 10.9974Z"
                                                                  fill="#3D92EF"/>
                                                            <path fillRule="evenodd" clipRule="evenodd"
                                                                  d="M11.7591 0C10.9508 0.00421839 10.1467 0.101241 9.35938 0.282632V4.07918C10.13 3.80499 10.9425 3.66578 11.7591 3.66156C12.5758 3.66578 13.3883 3.80499 14.1589 4.07497V0.274195C13.3716 0.097023 12.5674 0.00421839 11.7591 0ZM11.7591 7.16797C10.8838 7.16797 10.0378 7.47169 9.35938 8.02008V13.9807C10.0378 14.5291 10.888 14.8328 11.7591 14.8328C12.6345 14.8328 13.4804 14.5291 14.1589 13.9807V8.02008C13.4804 7.47169 12.6345 7.16797 11.7591 7.16797ZM11.767 18.3395C12.5836 18.3353 13.3961 18.1961 14.1667 17.9219V21.7184C13.3794 21.8998 12.5753 21.9968 11.767 22.0011C10.9587 21.9968 10.1545 21.9083 9.36719 21.7269V17.9261C10.1378 18.1961 10.9503 18.3353 11.767 18.3395Z"
                                                                  fill="#81BFFF"/>
                                                            <path fillRule="evenodd" clipRule="evenodd"
                                                                  d="M9.35938 9.99983C10.1509 9.89859 10.955 9.84797 11.7633 9.84375C12.5716 9.84797 13.3757 9.89859 14.1631 9.99561V21.7354C13.3757 21.8366 12.5716 21.8873 11.7633 21.8915C10.955 21.8873 10.1467 21.8366 9.35938 21.7396V9.99983Z"
                                                                  fill="#81BFFF"/>
                                                        </svg>
                                                        IO Coin
                                                    </div>
                                                ...
                                                <div className="content-ranking">
                                                    <div className="col-rankingg">
                                                        <div className="image"><img src={img6} alt="Binasea"/></div>
                                                    </div>
                                                    <div className="col-rankingg">Photography</div>
                                                    <div className="col-rankingg coin">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="22"
                                                    ...
                                                    <div className="inner tf-filter-container">
                                                        <div className="history-details tf-loadmore 3d">
                                                            <div className="authorr">
                                                                ...
                                                                <div className="content">
                                                                    ...
                                                                    <div className="description">started following <Link
                                                                        to="#">Grey Peep</Link></div>
                                                                    <div className="date">
                                                        ...
                                                        <div className="history-details tf-loadmore 3d anime">
                                                            <div className="authorr">
                                                                ...
                                                                <div className="content">
                                                                    <Link to="#" className="name">Baby Girl 3D
                                                                        Model</Link>
                                                                    <div className="description">purchased by <Link
                                                                        to="#">Monica Johnson</Link> for 4.00
                                                                        ETH
                                                                    </div>
                                                                    <div className="date">
                                                                        <span className="time">16:24</span>
                                                        ...
                                                        <div className="history-details tf-loadmore 3d pixel">
                                                            <div className="authorr">
                                                                ...
                                                                <div className="content">
                                                                    <Link to="#" className="name">Cyber Punk
                                                                        Gaming</Link>
                                                                    <div className="description">bidded by <Link to="#">Monica
                                                                        Johnson</Link> for 4.00 ETH
                                                                    </div>
                                                                    <div className="date">
                                                                        <span className="time">16:24</span>
                                                                        <span><i className="fas fa-circle"></i></span>
                                                        ...
                                                        <div className="history-details tf-loadmore 3d cyber">
                                                            <div className="authorr">
                                                                ...
                                                                <div className="content">
                                                                    <Link to="#" className="name">Cyber Punk
                                                                        Gaming</Link>
                                                                    <div className="description"><Link to="#">Monica
                                                                        Johnson</Link> offered for 4.00 ETH
                                                                    </div>
                                                                    <div className="date">
                                                                        <span className="time">16:24</span>
                                                                        <span><i className="fas fa-circle"></i></span>
                                                        ...
                                                        <div className="history-details tf-loadmore 3d cyber music">
                                                            <div className="authorr">
                                                                ...
                                                                <div className="content">
                                                                    <Link to="#" className="name">Cyber Punk
                                                                        Gaming</Link>
                                                                    <div className="description">liked by <Link to="#">Monica
                                                                        Johnson</Link> for 4.00 ETH
                                                                    </div>
                                                                    <div className="date">
                                                                        <span className="time">16:24</span>
                                                ...
                                                <div className="history-sidebar">
                                                    <div className="history-search">
                                                        <form action="#" method="get" role="search"
                                                              className="search-form"><input type="search"
                                                                                             id="s"
                                                            ...
                                                            <button className="search search-submit" type="submit"
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                    ...
                                                                    <mask id="mask1_2202_135862"
                                                                          maskUnits="userSpaceOnUse" x="10" y="10"
                                                                          width="6"
                                                                          height="6">
                                                                        <path fillRule="evenodd" clipRule="evenodd"
                                                    ...
                                                    <ul className="filter-menu">
                                                        <li className="active"><Link to="#" data-filter=".3d">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                                 height="20" viewBox="0 0 20 20"
                                                                 fill="none">
                                                                <path className="fill-svg"
                                                ...
                                                <div className="content-ranking">
                                                    <div className="col-rankingg">
                                                        <div className="box-product-favorite">
                                                            ...
                                                            <div className="image"><img src={imgp7} alt="Binasea"/>
                                                            </div>
                                                    ...
                                                    <div className="col-rankingg">0.45 Flow</div>
                                                    <div className="dot"><Link to="#"><i
                                                        className="fas fa-ellipsis-h"></i></Link></div>
                                                </div>
                                                <div className="content-ranking">
                                                    <div className="col-rankingg">
                                                        <div className="box-product-favorite">
                                                            ...
                                                            <div className="image"><img src={imgp1} alt="Binasea"/>
                                                            </div>
                                                ...
                                                <div className="content-ranking">
                                                    <div className="col-rankingg">
                                                        <div className="box-product-favorite">
                                                            ...
                                                            <div className="image"><img src={imgp2} alt="Binasea"/>
                                                            </div>
                                                ...
                                                <div className="content-ranking">
                                                    <div className="col-rankingg">
                                                        <div className="box-product-favorite">
                                                            ...
                                                            <div className="image"><img src={imgp3} alt="Binasea"/>
                                                            </div>
                                                ...
                                                <div className="content-ranking">
                                                    <div className="col-rankingg">
                                                        <div className="box-product-favorite">
                                                            ...
                                                            <div className="image"><img src={imgp4} alt="Binasea"/>
                                                            </div>
                                                ...
                                                <div className="content-ranking">
                                                    <div className="col-rankingg">
                                                        <div className="box-product-favorite">
                                                            ...
                                                            <div className="image"><img src={imgp5} alt="Binasea"/>
                                                            </div>
                                                ...
                                                <div className="content-ranking">
                                                    <div className="col-rankingg">
                                                        <div className="box-product-favorite">
                                                            ...
                                                            <div className="image"><img src={imgp6} alt="Binasea"/>
                                                            </div>
                                    ...
                                    {/*        <fieldset>*/}
                                    {/*          <h6>Address</h6>*/}
                                    {/*          <input type="text" placeholder="83222 Dicki View, South Pasqualeview, RI 79216-3100"*/}
                                    {/*                 required/>*/}
                                    {/*        </fieldset>*/}
                                    {/*      </div>*/}
